...
INSERT INTO WORKER  (WORKER_ID, FIRST_NAME, LAST_NAME, SALARY, JOINING_DATE, DEPARTMENT) 
VALUES
(009, 'Satish', 'Kumar', 100000, '14-02-20 09.00.00', 'HR');
...
SELECT * FROM WORKER WHERE SALARY BETWEEN 100000 and 500000; Question 8: Write an SQL query to fetch worker names with salaries >= 50000 and <= 100000. 
...
SELECT * FROM WORKER WHERE MONTH(JOINING_DATE)